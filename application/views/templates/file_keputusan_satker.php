		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    <li class="breadcrumb-item"><a href="<?php echo site_url('suratkeputusansatker/rekap') ?>">Surat Keputusan</a></li>
				    <li class="breadcrumb-item"><a href="<?php echo site_url('suratkeputusansatker/rekap') ?>">Rekap Surat Keputusan</a></li>
				    <li class="breadcrumb-item active" aria-current="page">File Surat Keputusan Satker</li>
				  </ol>
				</nav>
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<br>
                        <embed src="<?php echo base_url('upload/SuratKeputusanSatker/'.$surat->gambar) ?>" type="application/pdf" width="100%" height="700px"/>
