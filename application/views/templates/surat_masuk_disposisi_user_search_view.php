			...
			<div class="container-fluid">
				...
				<nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <?php endif;?>
                    <li class="breadcrumb-item active" aria-current="page">Disposisi Saya</li>
                  </ol>
                </nav>
				...
				<div class="card mb-3">
					<div class="card-body">
						<?php echo form_open('disposisi/searchUser') ?>
									...
									<tr>
										...
										<td width="250">
											...
											<a href="<?php echo site_url('disposisi/multi/'.$surat->id_surat_masuk) ?>"
											 ...
											 class="btn btn-small"><i class="fas fa-edit"></i> Status</a>
					                        <?php else:?>
					                        <?php endif;?>
