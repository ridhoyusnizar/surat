        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('disposisi/editUser') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" class="form-control" name="catatan_ketua" value="<?php echo $disposisi->catatan_ketua ?>" />


                            <div class="form-group row">
                                <label class="col-md-3 control-label">Catatan</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="catatan" value="<?php echo $disposisi->catatan ?>" />
                                </div>
                            </div>
