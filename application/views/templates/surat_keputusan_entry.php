			...
			<div class="container-fluid">
				...
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">Tambah Surat Keputusan Pjb</li>
				  </ol>
				</nav>
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php base_url('suratkeputusan/add') ?>" method="post" enctype="multipart/form-data" >
						...
						<div class="form-group row">
							<label class="col-md-3 control-label">No Surat</label>
								...
								<div class="col-md-2">
									<input type="text" class="form-control" name="no_surat_kelompok" value="Pjb" readonly/>
								</div>
								<div class="col-sm-1">
