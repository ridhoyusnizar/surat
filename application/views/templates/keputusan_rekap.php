        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <a class="btn btn-success" href="<?php echo base_url() ?>keputusan/export" style="float: right;"><i class="fas fa-file-excel"></i> Export Excel</a><br><br>
                            ...
                            <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($surat as $surat) : ?>
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td width="200"><a href="<?php echo site_url('keputusan/tampil/' . $surat->id_k) ?>">
                                            ...
                                            <td width="300">
                                                <?php if ($this->session->userdata('akses') == '3' || $this->session->userdata('akses') == '4') : ?>
                                                    <a href="<?php echo site_url('keputusan/tampilPDF/' . $surat->id_k) ?>" class="btn btn-small"><i class="fas fa-copy"></i> File</a>
                                                    <a href="<?php echo site_url('keputusan/edit/' . $surat->id_k) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                    <a onclick="deleteConfirm('<?php echo site_url('keputusan/delete/' . $surat->id_k) ?>')" href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i>Hapus</a>
                                                <?php else : ?>
                                                    <a href="<?php echo site_url('keputusan/tampilPDF/' . $surat->id_k) ?>" class="btn btn-small"><i class="fas fa-copy"></i> File</a>
                                                <?php endif; ?>
                                            </td>
