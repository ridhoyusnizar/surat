			...
			<div class="container-fluid">
				...
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">File Surat Keluar</li>
				  </ol>
				</nav>
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<br>
                        <embed src="<?php echo base_url('upload/suratkeluar/files/'.$surat_keluar->gambar) ?>" type="application/pdf" width="100%" height="700px"/>
