		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php base_url('surattugas/edit') ?>" method="post" enctype="multipart/form-data" >
						...
						<div class="form-group row">
									...
									<div class="col-md-8">
											<input class="form-control-file <?php echo form_error('gambar') ? 'is-invalid':'' ?>"
											 ...
											 <iframe src="<?php echo base_url('upload/suratTugas/'.$surat->gambar) ?>" style=”width: 100%;height: 100%;border: none;”></iframe>
