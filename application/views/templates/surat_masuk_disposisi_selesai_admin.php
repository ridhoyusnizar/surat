                                    ...
                                    <?php foreach ($surat as $surat) : ?>
                                        <tr>
                                            ...
                                            <td width="250">
                                                ...
                                                <a href="<?php echo site_url('disposisi/multi/' . $surat->id_surat_masuk) ?>" class="btn btn-small"><i class="fas fa-edit"></i>Disposisi</a>
                                                <a href="<?php echo site_url('printsuratkendali/print/' . $surat->id_surat_masuk) ?>" class="btn btn-small"><i class="fas fa-print"></i> Print</a>
                                                <?php if ($this->session->userdata('akses') == '3') : ?>
                                                    <a href="<?php echo site_url('suratmasuk/editStatus/' . $surat->id_surat_masuk) ?>" class="btn btn-small"><i class="fas fa-check-circle"></i> Status</a>
                                                <?php else : ?>
                                                <?php endif; ?>
                                            </td>
