...
{
    private $_table = "surat_keputusan_pjb";
    public $id_sk;
    public $tanggal;
    public $no_surat_no;
    ...
    {
        $config['upload_path']          = './upload/suratKeputusan';
    ...
    private function _deleteImage($id)
    {
        ...
        if ($surat->gambar != "default.jpg") {
            ...
            return array_map('unlink', glob(FCPATH . "upload/suratKeputusan/$filename.*"));
        }
    }
    ...
    function kode_()
    {
        ...
        $query = $this->db->get('surat_keputusan_pjb');
        if ($query->num_rows() <> 0) {
            $data = $query->row();
