...
class m_kep extends CI_Model
{
    ...
    {
        return $this->db->get_where($this->_table, ["id_k" => $id])->row();
    }
    ...
    public function delete($id)
    {
        ...
        return $this->db->delete($this->_table, array("id_k" => $id));
    }
    ...
    public function update()
    {
        ...
        $this->db->update($this->_table, $this, array('id_k' => $post['id_k']));
    }

    private function _uploadImage()
    {
        $config['upload_path']          = './upload/keputusan/';
    ...
    private function _deleteImage($id)
    {
        ...
        if ($surat->gambar != "default.jpg") {
            ...
            return array_map('unlink', glob(FCPATH . "upload/keputusan/$filename.*"));
        }
    }
